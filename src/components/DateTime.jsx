...
export default function MultiInputDateRangePicker({ setEndDate, setStartDate, startDate, endDate }) {
                ...
                modifiers: [
                  {
                    name: 'offset',
                    options: {
                      offset: [-63, 31], // adjust the offset if needed (horizontal, vertical)
                    },
                  },
                ],
              },
